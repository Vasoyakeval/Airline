					...
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
                            ...
                            // if()
								...
								echo "<option value='{$row['city']}'>{$row['city']},{$row['airport']}</option>";
								}
							...
							<div class="date">
								<div class="depart">
									<h3 >Depart</h3>
                                    <input type='date' class="form-control" name="dep_date" onchange="validateDate()" id='mydate' required=""></input>
									
								</div>
								<div class="return">
									<h3 >Return</h3>
                                    <input type='date' class="form-control" name="ret_date" onchange="validateDate1()" id='mdate' required="" onfocus="this.value = '';"></input>
								
                                    <script>
                                    function validateDate1() {
                                    var userdate = new Date(document.getElementById("mdate").value);
                                    var today = new Date();
                                    function isDateBeforeToday(date) {
                                        return new Date(date.toDateString()) < new Date(new Date().toDateString());
                                    }
                                    if(isDateBeforeToday(userdate))
                                    {
                                        document.getElementById("mydate").value="";
                                        alert('Enter feature date');
                                    }    
                                    }
                                    </script>
					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="book_flight.php" method="post">
							...
							<div class="date">
								<div class="depart">
									<h3 >Depart</h3>
                                    <input type='date' class="form-control" name="dep_date" onchange="validateDate2()" id='odate' required="" onfocus="this.value = '';"></input>
									<script>
                                    function validateDate2() {
                                    var userdate = new Date(document.getElementById("odate").value);
                                    var today = new Date();
                                    function isDateBeforeToday(date) {
                                        return new Date(date.toDateString()) < new Date(new Date().toDateString());
                                    }
