...
if(isset($_POST['reset-req-submit'])) {
    ...
    $url = 'https://secret-journey-48226.herokuapp.com/views/create-new-pwd.php?selector='.$selector.'&validator='.bin2hex($token);
    $expires = date('U')+1800;
    ...
    try {     
        ...
        $mail->Username   = "kevalvasoya20@gnu.ac.in";
        $mail->Password   = "hwsfbzzrfhxbcffj";
        $mail->IsHTML(true);
