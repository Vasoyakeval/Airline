 ...
 /* h5:hover{
    ...
    <body>
        ...
        <nav class="navbar navbar-custom navbar-expand-lg navbar-dark bg-primary">
          <!-- <a class="navbar-brand text-light"><h4>Airline - Admin</h4></a> -->
              ...
              if(isset($_SESSION['adminId'])) { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php">
                      <h5 class="ml-2 t1"> Dashboard</h5>
                    </a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" href="flight.php">
                      <h5 class="ml-2 t1"> Create Flight</h5>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="all_Airport.php">
                      <h5 class="ml-2 t1">Airport</h5>
                    </a>
                  </li>  
                  <li class="nav-item">
                    <a class="nav-link" href="all_flights.php">
                      <h5 class="ml-2 t1">Flights</h5>
                    </a>
                  </li>   
                  <li class="nav-item">
                    <a class="nav-link" href="list_airlines.php">
                      <h5 class="ml-2 t1">Airlines</h5>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="adminuser.php" id="user">
                        <h5 class="ml-2 t1">User</h5>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="passenger_pro.php" id="passenger">
                        <h5 class="ml-2 t1">Passenger</h5>
                    </a>
                </li>    
                <li class="nav-item">
                    <a class="nav-link" href="adminticket.php" id="tic">
                        <h5 class="ml-2 t1">Ticket</h5>
                    </a>
                </li> 
                  <li class="nav-item">
                    <a class="nav-link" href="adminfeedback.php" id="feed">
                        <h5 class="ml-2 t1"> Feedback</h5>
                    </a>
                </li>           
                  <li class="nav-item">
                    <a class="nav-link" href="admincticket.php">
                      <h5 class="ml-2 t1">C-Ticket</h5>
                    </a>
                  </li>                     
                </ul>
                  ...
                  <li class="nav-item">
                    <div class="dropdown mt-2">
                      <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
                        ...
                        <i class="fa fa-plus text-white"></i> Airport </td>
                      </button>  
                      <div class="dropdown-menu">
                        <form class="px-2 py-2"  action="../includes/admin/add_airport.inc.php" method="post">
                          ...
                          <button type="submit" name="btnAddAirport" 
